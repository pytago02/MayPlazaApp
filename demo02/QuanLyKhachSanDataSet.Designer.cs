...
namespace demo02 {
    ...
    public partial class QuanLyKhachSanDataSet : global::System.Data.DataSet {
        ...
        public partial class TaiKhoanDataTable : global::System.Data.TypedTableBase<TaiKhoanRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public TaiKhoanRow AddTaiKhoanRow(string tenDangNhap, string matKhau, string hoTen, string gioiTinh, string diaChi, string sdt) {
...
namespace demo02.QuanLyKhachSanDataSetTableAdapters {
    ...
    public partial class TaiKhoanTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TaiKhoan] WHERE (([tenDangNhap] = @Original_tenDangNhap) AND (" +
                "[matKhau] = @Original_matKhau) AND ([hoTen] = @Original_hoTen) AND ([gioiTinh] =" +
                " @Original_gioiTinh) AND ([diaChi] = @Original_diaChi) AND ([sdt] = @Original_sd" +
                "t))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[TaiKhoan] ([tenDangNhap], [matKhau], [hoTen], [gioiTinh], [diaChi], [sdt]) VALUES (@tenDangNhap, @matKhau, @hoTen, @gioiTinh, @diaChi, @sdt);
SELECT tenDangNhap, matKhau, hoTen, gioiTinh, diaChi, sdt FROM TaiKhoan WHERE (tenDangNhap = @tenDangNhap)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[TaiKhoan] SET [tenDangNhap] = @tenDangNhap, [matKhau] = @matKhau, [hoTen] = @hoTen, [gioiTinh] = @gioiTinh, [diaChi] = @diaChi, [sdt] = @sdt WHERE (([tenDangNhap] = @Original_tenDangNhap) AND ([matKhau] = @Original_matKhau) AND ([hoTen] = @Original_hoTen) AND ([gioiTinh] = @Original_gioiTinh) AND ([diaChi] = @Original_diaChi) AND ([sdt] = @Original_sdt));
SELECT tenDangNhap, matKhau, hoTen, gioiTinh, diaChi, sdt FROM TaiKhoan WHERE (tenDangNhap = @tenDangNhap)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::demo02.Properties.Settings.Default.QuanLyKhachSanConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT tenDangNhap, matKhau, hoTen, gioiTinh, diaChi, sdt FROM dbo.TaiKhoan";
        ...
        public virtual int Delete(string Original_tenDangNhap, string Original_matKhau, string Original_hoTen, string Original_gioiTinh, string Original_diaChi, string Original_sdt) {
        ...
        public virtual int Insert(string tenDangNhap, string matKhau, string hoTen, string gioiTinh, string diaChi, string sdt) {
            if ((tenDangNhap == null)) {
        ...
        public virtual int Update(string tenDangNhap, string matKhau, string hoTen, string gioiTinh, string diaChi, string sdt, string Original_tenDangNhap, string Original_matKhau, string Original_hoTen, string Original_gioiTinh, string Original_diaChi, string Original_sdt) {
            if ((tenDangNhap == null)) {
                throw new global::System.ArgumentNullException("tenDangNhap");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string matKhau, string hoTen, string gioiTinh, string diaChi, string sdt, string Original_tenDangNhap, string Original_matKhau, string Original_hoTen, string Original_gioiTinh, string Original_diaChi, string Original_sdt) {
            return this.Update(Original_tenDangNhap, matKhau, hoTen, gioiTinh, diaChi, sdt, Original_tenDangNhap, Original_matKhau, Original_hoTen, Original_gioiTinh, Original_diaChi, Original_sdt);
        }
    }
